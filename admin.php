...
<main class="main-content">
    ...
    <section class="card" id="users">
        ...
        <?php
        $stmt = $conn->prepare("SELECT id, email, name, phone, created_at, status FROM users");
        $stmt->execute();
    ...
    <section class="card" id="notifications">
        ...
        <form class="notif-form" id="notifForm" action="backend/sendnotification.php" method="POST">
