...
<button id="cookieSettingsBtn" class="cookie-floating-btn" onclick="reopenCookieSettings()" title="Süti beállítások">
    ...
    <!-- Hero Section -->
    <section class="rawpower-hero-section">
        <div class="rawpower-hero-background"></div>
        <div class="rawpower-hero-overlay"></div>
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-lg-8">
                    <h1 class="rawpower-hero-title" data-aos="fade-up" data-aos-delay="300">
                        Edzéseink
                        <!-- <span class="accent-text">Excellence</span> -->
                    </h1>
                    <p class="rawpower-hero-subtitle" data-aos="fade-up" data-aos-delay="500">
                        Raw Power
                    </p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    <div class="section-header" data-aos="fade-up">
                        <span class="section-subtitle">Raw Power</span>
                        <!-- <h2 class="section-title">Interior Design Services</h2> -->
                        <p class="section-description">A Nyers Erő edzés alapvetően a húzódzkodás, mint alapgyakorlat megtanulásához lett kitalálva. A résztvevő segédizmokat erősítjük, illetve nagy hangsúlyt fektetünk a fogóerő és a törzs izomzatának növelésére is. Ez utóbb kiegészült a fekvőtámaszban karhajlítás-nyújtás gyakorlat hasonlóan felépített javításával is. Ajánljuk az edzést, ha szeretnél komplex felsőtest erősítést végezni, hogy elérhesd a saját tested feletti teljes erőkontrollt.</p>
                    </div>
                </div>
            </div>
