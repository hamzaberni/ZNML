    ...
    <nav class="navbar navbar-expand-lg fixed-top" id="mainNav">
        <div class="container">
            ...
            <div class="right-links-block">
              <a href="https://www.facebook.com/share/1A96SNZ2Zh/?mibextid=wwXIfr" class="link">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="service-card">
                        <div class="service-icon">
                            <img src="assets/images/edzespics/fmt.jpg"
                                alt="Architecture">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="service-card">
                        <div class="service-icon">
                            <img src="assets/images/edzespics/strength.jpg"
                                alt="Interior Design">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="service-card">
                        <div class="service-icon">
                            <img src="assets/images/edzespics/hiit.jpg"
                                alt="Space Planning">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="400">
                    <div class="service-card">
                        <div class="service-icon">
                            <img src="assets/images/edzespics/core.jpg"
                ...
                <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="500">
                    <div class="service-card">
                        <div class="service-icon">
                            <img src="assets/images/edzespics/peach.jpg"
                                alt="Consultation">
                        </div>
                        <h3>Peach Body</h3>
                ...
                <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="600">
                    <div class="service-card">
                        <div class="service-icon">
                            <img src="assets/images/edzespics/ladies.jpg"
                ...
                <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="600">
                    <div class="service-card">
                        <div class="service-icon">
                            <img src="assets/images/edzespics/rawpower.jpg"
                                alt="3D Visualization">
                        </div>
                        <h3>Raw Power</h3>
                        <!-- <p>Photorealistic renderings and virtual walkthroughs that bring your project to life before
        ...
        <div class="container">
            ...
            <div class="col-lg-10 mx-auto">
                <div class="timetable-image" data-aos="fade-up" data-aos-delay="200">
                    <img src="assets/images/timetable.jpg" alt="Órarend" class="img-fluid">
                </div>
            </div>
        </div>
        </div>
                ...
                <div class="portfolio-item residential" data-aos="fade-up" data-aos-delay="100">
                    <div class="portfolio-card">
                        <div class="portfolio-image">
                            <img src="assets/images/comingsoon.png" alt="Pekárovics Zoltán">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-4">
                    ...
                    <li>
                        <a href="https://www.facebook.com/share/1A96SNZ2Zh/?mibextid=wwXIfr" class="social-icon-circle">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <path
