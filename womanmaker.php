...
<head>
    ...
    <title>WoManMaker – ZOONIMAL</title>
    <meta name="description" content="Közösségépítő felsőtest fókuszú fun edzés párban, ahol antagonista izmokat erősítünk jó hangulatban. ZOONIMAL edzőterem.">
    <meta name="keywords" content="womanmaker, felsőtest edzés, páros edzés, közösségi edzés, zoonimal">
...
<button id="cookieSettingsBtn" class="cookie-floating-btn" onclick="reopenCookieSettings()" title="Süti beállítások">
    ...
    <nav class="navbar navbar-expand-lg fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="index.php">
                <span class="brand-text">ZNML</span>
    ...
    <!-- Hero Section -->
    <section class="manmaker-hero-section">
        <div class="manmaker-hero-background"></div>
        <div class="manmaker-hero-overlay"></div>
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-lg-8">
                    <h1 class="manmaker-hero-title" data-aos="fade-up" data-aos-delay="300">
                        Edzéseink
                        <!-- <span class="accent-text">Excellence</span> -->
                    </h1>
                    <p class="manmaker-hero-subtitle" data-aos="fade-up" data-aos-delay="500">
                        WoManMaker
                    </p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    <div class="section-header" data-aos="fade-up">
                        <span class="section-subtitle">WoManMaker</span>
                        <!-- <h2 class="section-title">Interior Design Services</h2> -->
                        <p class="section-description">Közösségépítő jellegű, felsőtest fókuszú "fun" edzés, ahol párban végezzük a különböző antagonista izmok erősítését. Hipertrófia domináns, alsótest gyakorlatokat csak nyomokban tartalmazó buli, ahol időre dolgozunk. Mindenkinek ajánlom, aki szeretné, hogy jó hangulatban robbantsa fel a felsőtestét.<br>U.i.:  Félreértés ne essék, a lányok-fiúk aránya fele-fele, sőt, néha többen vannak a hölgyek!</p>
                    </div>
                </div>
            </div>
