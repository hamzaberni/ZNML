...
<head>
    ...
    <title>Ladies First – ZOONIMAL</title>
    <meta name="description" content="Farizom növelésére és formálására specializált óra nagy súlyokkal, kevés de hatékony gyakorlattal. ZOONIMAL edzőterem.">
    <meta name="keywords" content="ladies first, farizom edzés, női edzés, zoonimal">    
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    <div class="section-header" data-aos="fade-up">
                        <span class="section-subtitle">Ladies First</span>
                        <!-- <h2 class="section-title">Interior Design Services</h2> -->
                        <p class="section-description">Egy óra ami kifejezetten a farizom növeléséről és formálásáról szól. Nagy súlyokkal dolgozunk, kevés, de annál hatékonyabb gyakorlatot végzünk.</p>
                    </div>
                </div>
            </div>
