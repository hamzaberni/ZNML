            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="navbarOffcanvas">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="consultation.html">Kapcsolat</a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row align-items-stretch">
            ...
            <div class="col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="500">
                <div class="consult-package-card featured h-100">
                    ...
                    <a href="index.html#portfolio" class="btn btn-primary-price w-100 mt-auto">Kapcsolatfelvétel az edzőkkel</a>
                </div>
            </div>
            <div class="col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="600">
                <div class="consult-package-card featured h-100">
                    ...
                    <div class="card-spacer"></div>
                    <a href="kapcsolat.html#consultation-form" class="btn btn-primary-price w-100 mt-auto">Érdeklődés</a>
                </div>
            </div>
        </div>
    </div>
