...
<button id="cookieSettingsBtn" class="cookie-floating-btn" onclick="reopenCookieSettings()" title="Süti beállítások">
    ...
    <section class="space-hero-section">
        <div class="space-hero-background"></div>
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    <div class="section-header" data-aos="fade-up">
                        <span class="section-subtitle">Magas intenzitású intervallum edzés<br>HIIT</span>
                        <!-- <h2 class="section-title">Interior Design Services</h2> -->
                        <p class="section-description">A magas intenzitású intervall edzés rövid, pörgős szakaszokból áll - intenzív, magas pulzustartományban végzett munkát nyugalmi pihenőszakasz követ, így magas intenzitás mellett is hatékonyan tudjuk a gyakorlatokat elvégezni a technika és a szabályos kivitelezés kompromittálását elkerülve. Ideális állóképesség javítására, erősítésre és izomépítésre, illetve kalóriák tömeges égetésére.</p>
                    </div>
                </div>
            </div>
