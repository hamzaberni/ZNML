...
<head>
    ...
    <title>Peach Body – ZOONIMAL</title>
    <meta name="description" content="Alsó- és felsőtest egyaránt hangsúlyos szerepet kap a Peach Body edzésen. ZOONIMAL funkcionális edzőterem.">
    <meta name="keywords" content="peach body, testformálás, funkcionális edzés, zoonimal">
...
<button id="cookieSettingsBtn" class="cookie-floating-btn" onclick="reopenCookieSettings()" title="Süti beállítások">
    ...
    <!-- Hero Section -->
    <section class="peach-hero-section">
        <div class="peach-hero-background"></div>
        <div class="peach-hero-overlay"></div>
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-lg-8">
                    <h1 class="peach-hero-title" data-aos="fade-up" data-aos-delay="300">
                        Edzéseink
                        <!-- <span class="accent-text">Excellence</span> -->
                    </h1>
                    <p class="peach-hero-subtitle" data-aos="fade-up" data-aos-delay="500">
                        Peach Body
                    </p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    <div class="section-header" data-aos="fade-up">
                        <span class="section-subtitle">Peach Body</span>
                        <!-- <h2 class="section-title">Interior Design Services</h2> -->
                        <p class="section-description">Az edzések során az alsó- és felsőtest egyaránt hangsúlyos szerepet kap. 
                        Az erős farizom stabilizálja a csípőt és a térdet, tehermentesíti a derekat, segít megelőzni a hát- és derékfájást, alapja a robbanékony erőnek és a hatékony mozgásnak. 
                        A felsőtest ereje ugyanolyan fontos. Segít az emelésben, cipelésben, javítja a testtartást, védi a nyakat és a hátat, megkönnyíti a mindennapi mozgásokat.
                        Az órákon célunk az erő fokozatos növelése mellett az állóképesség fejlesztése és fenntartása is, hogy a test ne csak erős, hanem terhelhető és hosszú távon is jól működő maradjon. </p>
                    </div>
                </div>
            </div>
