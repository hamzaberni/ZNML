...
<head>
    ...
    <title>Core Training – ZOONIMAL</title>
    <meta name="description" content="A jól funkcionáló törzs az alapja mindennek. Core Training óra a ZOONIMAL funkcionális edzőteremben.">
    <meta name="keywords" content="core training, törzserősítés, funkcionális edzés, zoonimal">    
...
<button id="cookieSettingsBtn" class="cookie-floating-btn" onclick="reopenCookieSettings()" title="Süti beállítások">
    ...
    <!-- Hero Section -->
    <section class="core-hero-section">
        <div class="core-hero-background"></div>
        <div class="core-hero-overlay"></div>
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-lg-8">
                    <h1 class="core-hero-title" data-aos="fade-up" data-aos-delay="300">
                        Edzéseink
                    </h1>
                    <p class="core-hero-subtitle" data-aos="fade-up" data-aos-delay="500">
                        Core training
                    </p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    <div class="section-header" data-aos="fade-up">
                        <span class="section-subtitle">Core training</span>
                        <!-- <h2 class="section-title">Interior Design Services</h2> -->
                        <p class="section-description">A jól funkcionáló törzs az alapja mindennek, így ezen az órán erre fektetjük a hangsúlyt. A pulzusod nem lesz az egekben, sőt, nagyon látványos feladatokat se fogsz végezni, de garantált a törzsizomzat elfáradása, fejlődése és a használatának a megtanulása!</p>
                    </div>
                </div>
            </div>
